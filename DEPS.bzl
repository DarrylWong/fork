...
def go_deps():
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/crlib@v0.0.0-20241030165019-b010812ae6c8",
        urls = [
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20241101200137-71bb6ba29095",
        urls = [
