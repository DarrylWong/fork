...
// registerStopAndCopyGossipBootstrap tests that the cockroach debug clear-gossip-bootstrap
...
func registerStopAndCopyGossipBootstrap(r registry.Registry) {
	...
	r.Add(registry.TestSpec{
		Name:             "stop-and-copy/clear-gossip-bootstrap",
	...
	r.Add(registry.TestSpec{
		Name:             "stop-and-copy/stale-gossip-bootstrap",
		Owner:            registry.OwnerTestEng,
		Cluster:          r.MakeClusterSpec(2 * nodesPerCluster),
		CompatibleClouds: registry.AllClouds,
		Suites:           registry.Suites(registry.Nightly),
