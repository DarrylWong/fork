...
// ExpectDeaths alerts the testing infrastructure that a node(s) is
...
// events.
func (h *Helper) ExpectDeaths(nodes option.NodeListOption) {
	h.runner.monitor.ExpectDeaths(nodes)
}
