...
func TestBasicBuilder(t *testing.T) {
	...
	require.Equal(t, 0, stepA.indegree, "A should not be dependent on any step")
	...
	require.Equal(t, 1, stepB.indegree, "B should depend on A")
	...
	require.Equal(t, 1, stepC.indegree, "C should depend on B")
...
func TestAndBuilder(t *testing.T) {
	...
	require.Equal(t, 1, stepD.indegree, "D should depend on B")
	...
	require.Equal(t, 2, stepE.indegree, "E should depend on C and D")
