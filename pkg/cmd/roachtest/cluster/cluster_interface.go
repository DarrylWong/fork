...
type Cluster interface {
	...
	InternalPGUrl(ctx context.Context, l *logger.Logger, node option.NodeListOption, tenant string, sqlInstance int, passwordAuth bool) ([]string, error)
	ExternalPGUrl(ctx context.Context, l *logger.Logger, node option.NodeListOption, tenant string, sqlInstance int, passwordAuth bool) ([]string, error)
