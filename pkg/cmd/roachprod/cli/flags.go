...
func initStartCmdFlags(startCmd *cobra.Command) {
	...
	startCmd.Flags().BoolVar(&startOpts.DiscardPersistedBootstrapAddresses,
		"discard-persisted-bootstrap-addresses", startOpts.DiscardPersistedBootstrapAddresses, "discard cached bootstrap addresses on startup")
}
