...
func PgURL(
	...
	for i, ip := range ips {
		...
		urls = append(urls, c.NodeURL(ip, desc.Port, opts.VirtualClusterName, desc.ServiceMode, opts.Auth, install.NodeURLOpts{User: opts.User, Password: opts.Password, Database: opts.Database}))
	}
