...
func CreateLoadBalancer(
	...
	services, err := c.ServiceDescriptors(
		ctx, c.TargetNodes(), virtualClusterName, install.ServiceTypeSQL, sqlInstance,
	)
	if err != nil {
		return err
	}
...
func LoadBalancerIP(
	...
	services, err := c.ServiceDescriptors(ctx, c.TargetNodes(), virtualClusterName, install.ServiceTypeSQL, sqlInstance)
	if err != nil {
		return "", err
	}
	port := config.DefaultSQLPort
