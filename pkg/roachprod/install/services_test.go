...
func newServiceRegistryTest(t *testing.T, rng *rand.Rand, provider vm.DNSProvider, providerName string) serviceRegistryTest {
...
func (t *serviceRegistryTest) portFunc(ctx context.Context, l *logger.Logger, node Node, startPort, count int) ([]int, error) {
