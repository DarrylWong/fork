...
func IngestExternalCatalog(
	...
	// Our copied descriptor IDs are from the source cluster and don't point to
	// valid descriptors on the destination cluster. We need to generate new IDs
	// to point at. We do this by constructing a mapping of old to new IDs, and
	// passing this mapping to Rewrite().
