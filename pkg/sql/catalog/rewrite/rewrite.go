...
func rewriteTypesInExpr(expr catpb.Expression, rewrites jobspb.DescRewriteMap) (catpb.Expression, error) {
...
func rewriteTypesInView(viewQuery catpb.Statement, rewrites jobspb.DescRewriteMap) (catpb.Statement, error) {
...
func rewriteSequencesInExpr(expr catpb.Expression, rewrites jobspb.DescRewriteMap) (catpb.Expression, error) {
	parsed, err := parser.ParseExpr(string(expr))
	if err != nil {
		return "", err
	}
...
func rewriteFunctionsInExpr(expr catpb.Expression, rewrites jobspb.DescRewriteMap) (catpb.Expression, error) {
	parsed, err := parser.ParseExpr(string(expr))
	if err != nil {
		return "", err
	}
...
func rewriteSequencesInView(viewQuery catpb.Statement, rewrites jobspb.DescRewriteMap) (catpb.Statement, error) {
	stmt, err := parser.ParseOne(string(viewQuery))
	if err != nil {
		return "", err
	}
