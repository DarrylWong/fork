...
func (m *sliMetrics) getRangeStatsCallback() func(r *rangescanstats.RangeStatsPoller, totalRangeCount, scanningRangeCount, laggingRangeCount int64) {
	...
	return func(r *rangescanstats.RangeStatsPoller, totalRangeCount, scanningRangeCount, laggingRangeCount int64) {
		last.Lock()
		defer last.Unlock()

		m.LaggingRanges.Dec(last.lagging - laggingRangeCount)
		last.lagging = laggingRangeCount

		m.ScanningRanges.Dec(last.scanning - scanningRangeCount)
		last.scanning = scanningRangeCount

		m.TotalRanges.Dec(last.total - totalRangeCount)
		last.total = totalRangeCount
	}
}
