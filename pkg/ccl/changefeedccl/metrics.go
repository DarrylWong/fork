...
func (m *sliMetrics) getRangeStatsCallback() func(totalRangeCount, scanningRangeCount, laggingRangeCount int64) {
	...
	return func(totalRangeCount, scanningRangeCount, laggingRangeCount int64) {
		last.Lock()
		defer last.Unlock()
